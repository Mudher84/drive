          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-telegram-hover/20 border border-telegram-border/30 space-y-4">
              ...
              <div className="flex flex-col items-center py-3 space-y-4">
                <img src="/logo.svg" className="w-14 h-14 drop-shadow-lg" alt="Yam Drive Logo" />
                <div className="text-center">
                  <p className="text-sm font-bold text-telegram-text">Yam Drive</p>
                ...
                <div className="text-center space-y-2.5">
                  <p className="text-xs font-semibold text-telegram-text">Mudher Al.Bayai</p>

                  <button
                    onClick={(e) => { e.preventDefault(); openUrl('https://www.wana84.com'); }}
                  ...
                  <button
                    onClick={(e) => { e.preventDefault(); openUrl('https://github.com/Mudher84/drive'); }}
                    className="flex items-center justify-center gap-1.5 text-[11px] text-telegram-primary hover:text-telegram-primary/80 transition-colors cursor-pointer"
                  >
