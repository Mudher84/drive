...
pub async fn start_server(
    ...
    // Created once and shared across all workers so the failed-attempt count
    // for a share link is tracked consistently, not reset per-request.
    let share_limiter_data = web::Data::new(crate::share_routes::ShareAttemptLimiter::new());
    ...
    let server = HttpServer::new(move || {
        ...
        App::new()
            ...
            .app_data(share_limiter_data.clone())
            .service(ad_banner)
